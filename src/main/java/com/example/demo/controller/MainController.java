...
public class MainController {
    ...
    @GetMapping
    public List<StudentEntity> getProducts() {
        return studentService.getAll();
    }

    @GetMapping(value = "/{student_id}")
    public Optional<StudentEntity> getSpecProduct(@PathVariable("student_id") String student_id) {
    ...
    public void updateProduct(@Valid @PathVariable("student_id") String student_id, @Valid @RequestBody RequestModel userDetailsModel){
        // copy json to dto in
    ...
    public void deleteProduct(@PathVariable("student_id") String student_id) {
